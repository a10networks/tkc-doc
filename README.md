# A10 Networks Thunder Kubernetes Connector i.e TKC (Documents)
...
For additional details of the working on TKC with A10's Application Delivery Controller (ADC) please reference documentation at https://documentation.a10networks.com/Install/Software/A10_ACOS_Install/index.html#tkc 
...
With the availability of HELM charts, the DevOps or the NetOps team can completely automate the deployment and updates of TKC using their CI/CD process. The access to these HELM charts are available on A10’s Github page. And Terraform scripts will help automate and scale the orchestration and configuration of Thunder ADC.    
